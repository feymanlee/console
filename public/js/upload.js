...
MyAjax.prototype.handle = function (a, b) {
  ...
  this.transit = !1, this.stop = this.erromsg = !1, b = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"), a.type = a.type.toUpperCase(), c = function () {
  }, "string" == typeof a.data ? (a.data = a.data.replace(/(^\s*)|(\s*$)/g, ""), c = function () {
