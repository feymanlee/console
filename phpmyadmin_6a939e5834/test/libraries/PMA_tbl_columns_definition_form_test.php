...
class PMA_TblColumnsDefinitionFormTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetFormsParameters()
    {
        ...
        $result = PMA_getFormsParameters(
            "dbname", "tablename", "tbl_create.php", 22, [12, 13]
        );
    ...
    public function testGetHeaderCells()
    {
        ...
        $result                       = PMA_getHeaderCells(false, [], true, 'db', 'table');
    ...
    public function testGetRowDataForRegeneration()
    {
        $_REQUEST = [
            'field_name'          => [1 => 'name'],
            'field_type'          => [1 => 'type'],
            'field_collation'     => [1 => 'colltn'],
            'field_null'          => [1 => true],
            'field_key'           => [1 => "fulltext_1"],
            'field_default_type'  => [1 => 'USER_DEFINED'],
            'field_default_value' => [1 => 'DEF'],
            'field_extra'         => [1 => 'extra'],
        ];
    ...
    public function testGetSubmitPropertiesForRegeneration()
    {
        $_REQUEST = [
            'field_length'                    => [1 => 22],
            'field_attribute'                 => [1 => 'attr'],
            'field_default_current_timestamp' => [],
        ];
    ...
    {
        $_REQUEST = [
            'field_comments'               => [1 => 'comm'],
            'field_mimetype'               => [1 => 'mime'],
            'field_transformation'         => [1 => 'trans'],
            'field_transformation_options' => [1 => 'transops'],
        ];

        $result = PMA_handleRegeneration(1, 'FULLTEXT', [], []);
    ...
    public function testGetHtmlForColumnType()
    {
        ...
        $result               = PMA_getHtmlForColumnType(
            1, 4, 3, false, ['column_status' => ['isReferenced' => false,
