...
class PMA_Table_Test extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        PMA_Table::$cache["PMA"]["PMA_BookMark"] = [
            'ENGINE'      => true,
            'Create_time' => true,
            'TABLE_TYPE'  => true,
            'Comment'     => true,
    ...
    public function testAnalyzeStructure()
    {
        ...
        $this->assertEquals(
            ['type' => 'INT', 'timestamp_not_null' => false],
            $show_create_table[0]['create_table_fields']['id']
        );
        $this->assertEquals(
            ['type' => 'TEXT', 'timestamp_not_null' => false],
    ...
    public function testIsMerge()
    {
        ...
        $table                         = 'PMA_BookMark';
        $db                            = 'PMA';
        PMA_Table::$cache[$db][$table] = ['table_name' => "PMA_BookMark"];
        ...
        PMA_Table::$cache[$db][$table] = ['ENGINE' => "MRG_MYISAM"];
        $result                        = PMA_Table::isMerge($db, $table);
        $this->assertEquals(
            true,
            $result
        ...
        PMA_Table::$cache[$db][$table] = ['ENGINE' => "ISDB"];
        $result                        = PMA_Table::isMerge($db, $table);
        $this->assertEquals(
            false,
            $result
    ...
    public function testCountRecords()
    {
        $table                         = 'PMA_BookMark';
        $db                            = 'PMA';
        PMA_Table::$cache[$db][$table] = ['Comment' => "Comment222"];
