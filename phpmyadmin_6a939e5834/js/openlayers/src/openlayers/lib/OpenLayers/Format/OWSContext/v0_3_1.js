    ...
    "owc": {
      ...
      "_WMS": function (layer) {
        ...
        this.writeNode("Server", {
          ...
          version: layer.params.VERSION, url: layer.url
        }, node);
      ...
      "_GML": function (layer) {
        ...
        this.writeNode("Server", {
          ...
          url: layer.protocol.url, version: layer.protocol.format.version
        }, node);
        return node;
      },
      "_KML": function (layer) {
        ...
        this.writeNode("Server", {
          ...
          version: layer.protocol.format.version, url: layer.protocol.url
        }, node);
        return node;
      }
    },
