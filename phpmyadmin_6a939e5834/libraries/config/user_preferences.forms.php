...
$forms['Main_panel']['Tabs']                    = [
    ...
    'DefaultTabDatabase',
    'DefaultTabTable'];
$forms['Main_panel']['DisplayRelationalSchema'] = [
    'PDFDefaultPageSize'];

$forms['Import']['Import_defaults']  = [
    'Import/format',
    'Import/charset',
