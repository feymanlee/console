...
class TCPDF_COLORS
{
     ...
     * manufacturers and insert the values and names of spot colours directly. Common industry standard spot colors
     * are: ANPA-COLOR, DIC, FOCOLTONE, GCMI, HKS, PANTONE, TOYO, TRUMATCH.
     * @public static
     */
    ...
    /**
     * Returns an array (RGB or CMYK) from an html color name, or a six-digit (i.e. #3FE5AA), or three-digit (i.e.
     * #7FF) hexadecimal color, or a javascript color array, or javascript color name.
     *
