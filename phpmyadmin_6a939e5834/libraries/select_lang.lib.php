...
function PMA_langDetails($lang)
{
    switch ($lang) {
        ...
        case 'az':
            return ['az|azerbaijani', 'az', 'Az&#601;rbaycanca'];
        case 'bn':
            return ['bn|bangla', 'bn', 'বাংলা'];
        case 'be':
            return [
                'be|belarusian',
                'be',
        ...
        case 'be@latin':
            return ['be[-_]lat|belarusian latin', 'be-lat', 'Bie&#0322;aruskaja'];
        case 'bg':
            return [
                'bg|bulgarian',
                'bg',
        ...
        case 'bs':
            return ['bs|bosnian', 'bs', 'Bosanski'];
        case 'br':
            return ['br|breton', 'br', 'Brezhoneg'];
        case 'ca':
            return ['ca|catalan', 'ca', 'Catal&agrave;'];
        case 'ckb':
            return ['ckb', 'ckb', 'سۆرانی'];
        case 'cs':
            return ['cs|czech', 'cs', 'Čeština'];
        case 'cy':
            return ['cy|welsh', 'cy', 'Cymraeg'];
        case 'da':
            return ['da|danish', 'da', 'Dansk'];
        case 'de':
            return ['de|german', 'de', 'Deutsch'];
        case 'el':
            return [
                'el|greek',
                'el',
        ...
        case 'en_GB':
            return ['en[_-]gb|english (United Kingdom)', 'en-gb', ''];
        case 'eo':
            return ['eo|esperanto', 'eo', 'Esperanto'];
        case 'es':
            return ['es|spanish', 'es', 'Espa&ntilde;ol'];
        case 'et':
            return ['et|estonian', 'et', 'Eesti'];
        case 'eu':
            return ['eu|basque', 'eu', 'Euskara'];
        case 'fa':
            return ['fa|persian', 'fa', '&#1601;&#1575;&#1585;&#1587;&#1740;'];
        case 'fi':
            return ['fi|finnish', 'fi', 'Suomi'];
        case 'fr':
            return ['fr|french', 'fr', 'Fran&ccedil;ais'];
        case 'fy':
            return ['fy|frisian', 'fy', 'Frysk'];
        case 'gl':
            return ['gl|galician', 'gl', 'Galego'];
        case 'he':
            return ['he|hebrew', 'he', '&#1506;&#1489;&#1512;&#1497;&#1514;'];
        case 'hi':
            return ['hi|hindi', 'hi', '&#2361;&#2367;&#2344;&#2381;&#2342;&#2368;'];
        case 'hr':
            return ['hr|croatian', 'hr', 'Hrvatski'];
        case 'hu':
            return ['hu|hungarian', 'hu', 'Magyar'];
        case 'hy':
            return ['hy|armenian', 'hy', 'Հայերէն'];
        case 'ia':
            return ['ia|interlingua', 'ia', 'Interlingua'];
        case 'id':
            return ['id|indonesian', 'id', 'Bahasa Indonesia'];
        case 'it':
            return ['it|italian', 'it', 'Italiano'];
        case 'ja':
            return ['ja|japanese', 'ja', '&#26085;&#26412;&#35486;'];
        case 'ko':
            return ['ko|korean', 'ko', '&#54620;&#44397;&#50612;'];
        case 'ka':
            return [
                'ka|georgian',
                'ka',
        ...
        case 'kk':
            return ['kk|kazakh', 'kk', 'Қазақ'];
        case 'km':
            return ['km|khmer', 'km', 'ខ្មែរ'];
        case 'kn':
            return ['kn|kannada', 'kn', 'ಕನ್ನಡ'];
        case 'ksh':
            return ['ksh|colognian', 'ksh', 'Kölsch'];
        case 'ky':
            return ['ky|kyrgyz', 'ky', 'Кыргызча'];
        case 'li':
            return ['li|limburgish', 'li', 'Lèmbörgs'];
        case 'lt':
            return ['lt|lithuanian', 'lt', 'Lietuvi&#371;'];
        case 'lv':
            return ['lv|latvian', 'lv', 'Latvie&scaron;u'];
        case 'mk':
            return ['mk|macedonian', 'mk', 'Macedonian'];
        case 'ml':
            return ['ml|malayalam', 'ml', 'Malayalam'];
        case 'mn':
            return [
                'mn|mongolian',
                'mn',
        ...
        case 'ms':
            return ['ms|malay', 'ms', 'Bahasa Melayu'];
        case 'ne':
            return ['ne|nepali', 'ne', 'नेपाली'];
        case 'nl':
            return ['nl|dutch', 'nl', 'Nederlands'];
        case 'nb':
            return ['nb|norwegian', 'nb', 'Norsk'];
        case 'pa':
            return ['pa|punjabi', 'pa', 'ਪੰਜਾਬੀ'];
        case 'pl':
            return ['pl|polish', 'pl', 'Polski'];
        case 'pt_BR':
            return ['pt[-_]br|brazilian portuguese', 'pt-BR', 'Portugu&ecirc;s'];
        case 'pt':
            return ['pt|portuguese', 'pt', 'Portugu&ecirc;s'];
        case 'ro':
            return ['ro|romanian', 'ro', 'Rom&acirc;n&#259;'];
        case 'ru':
            return [
                'ru|russian',
                'ru',
        ...
        case 'si':
            return ['si|sinhala', 'si', '&#3523;&#3538;&#3458;&#3524;&#3517;'];
        case 'sk':
            return ['sk|slovak', 'sk', 'Sloven&#269;ina'];
        case 'sl':
            return ['sl|slovenian', 'sl', 'Sloven&scaron;&#269;ina'];
        case 'sq':
            return ['sq|albanian', 'sq', 'Shqip'];
        case 'sr@latin':
            return ['sr[-_]lat|serbian latin', 'sr-lat', 'Srpski'];
        case 'sr':
            return [
                'sr|serbian',
                'sr',
        ...
        case 'sv':
            return ['sv|swedish', 'sv', 'Svenska'];
        case 'ta':
            return ['ta|tamil', 'ta', 'தமிழ்'];
        case 'te':
            return ['te|telugu', 'te', 'తెలుగు'];
        case 'th':
            return [
                'th|thai',
                'th',
        ...
        case 'tk':
            return ['tk|turkmen', 'tk', 'türkmençe'];
        case 'tr':
            return ['tr|turkish', 'tr', 'T&uuml;rk&ccedil;e'];
        case 'tt':
            return ['tt|tatarish', 'tt', 'Tatar&ccedil;a'];
        case 'ug':
            return ['ug|uyghur', 'ug', 'ئۇيغۇرچە'];
        case 'uk':
            return [
                'uk|ukrainian',
                'uk',
        ...
        case 'ur':
            return ['ur|urdu', 'ur', 'اُردوُ'];
        case 'uz@latin':
            return ['uz[-_]lat|uzbek-latin', 'uz-lat', 'O&lsquo;zbekcha'];
        case 'uz':
            return [
        ...
        case 'vi':
            return ['vi|vietnamese', 'vi', 'Tiếng Việt'];
        case 'vls':
            return ['vls|flemish', 'vls', 'West-Vlams'];
        case 'zh_TW':
            return [
...
if (in_array($GLOBALS['lang'], ['ar', 'fa', 'he', 'ur'])) {
