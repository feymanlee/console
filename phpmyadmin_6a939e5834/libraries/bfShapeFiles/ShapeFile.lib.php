...
class ShapeFile
{
    ...
    var $boundingBox = ["xmin" => 0.0, "ymin" => 0.0, "xmax" => 0.0, "ymax" => 0.0];
    var $fileLength  = 0;
    var $shapeType   = 0;

    var $records;

    public function __construct($shapeType, $boundingBox = ["xmin" => 0.0, "ymin" => 0.0, "xmax" => 0.0, "ymax" => 0.0], $FileName = NULL)
    {
