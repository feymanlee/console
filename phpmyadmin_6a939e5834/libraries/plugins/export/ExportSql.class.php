...
class ExportSql extends ExportPlugin
{
    ...
    public function replaceWithAliases(
        ...
        for ($i = 0; $i < $size && !$query_end; $i++) {
            ...
            $d_upper      = /*overload*/
                mb_strtoupper($d_unq);
            $d_upper_next = /*overload*/
                mb_strtoupper($d_unq_next);
            $d_upper_prev = /*overload*/
                mb_strtoupper($d_unq_prev);
