...
// +----------------------------------------------------------------------
// | Author: 黄文良 <2879625666@qq.com> & ThinkPHP
// +----------------------------------------------------------------------
...
function SendSocket($data, $rcv = 30, $snd = 5)
{
    ...
    socket_set_option($socket, SOL_SOCKET, SO_RCVTIMEO, ["sec" => $rcv, "usec" => 0]);
    socket_set_option($socket, SOL_SOCKET, SO_SNDTIMEO, ["sec" => $snd, "usec" => 0]);
